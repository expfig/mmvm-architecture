...
/**
 * Mock Service Worker é uma biblioteca de simulação de API que permite escrever simulações
 *  independentes do cliente e reutilizá-las em qualquer estrutura, ferramenta e ambiente.
 */
